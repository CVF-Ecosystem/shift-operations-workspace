...
_Last updated: 2026-07-31 (P2-C mutation/full UI DESIGN authored; independent review next)_

## Where the project is
**2026-07-31 (P2-C mutation/full UI — DESIGN_AUTHORED / PENDING_REVIEW):** ADR resolves intake F1-F6 with truthful single-workspace scope, real shift assignments, server capabilities, expected-version mutation checks, explicit operator/supervisor UI matrices and three gated BUILD checkpoints (authorization foundation → operator UI → supervisor closeout UI); P2-D and the full-shift exit run remain separate. Next move is independent DESIGN review; no SPEC/WORK_ORDER/BUILD authority. **P2-R operational Report + freeze prerequisite remains FREEZE / CLOSED_BOUNDED:** C3 `18e24e58e2bda83e18be21d5d25ad50c4b0fa24e` changed exactly 59 authorized paths and is pushed after independent final `REVIEW_PASS`; final evidence focused 385, full 998/87 skipped, disposable PostgreSQL 77, retained provider receipt, doctor 24/1 and exact-parent rehearsal 788/77. Its claim remains only exact R33; no P5-A, managed PostgreSQL, P2-C/P2-D or Phase-2 completion.
