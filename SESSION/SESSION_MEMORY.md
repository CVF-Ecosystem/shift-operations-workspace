...
**2026-08-03 (P3-A REFINERY — DESIGN AMENDMENT 1 PASS / SPEC RESUMED):** INTAKE and repaired DESIGN passed independently; SPEC translation then caught a real contradiction—dedupe preceded redaction while requiring redacted matching, and final candidate fingerprint included source identity. Amendment 1 preserves parent ADR `57ec06fc…e696e`, moves dedupe after redaction, and separates source, source-free dedupe-content and final-candidate SHA-256+SHA-512+length fingerprints. Independent `DESIGN_AMENDMENT_REVIEW_PASS` binds Amendment `dc091f2b…f0e4a`, no waiver. SPEC authoring resumes. No WORK_ORDER/BUILD/provider, P3-B/P3-C, retrieval/RAG/learning or production authority.
