...
_Last updated: 2026-07-31 (P2-C SPEC authored; independent review next)_

## Where the project is
**2026-07-31 (P2-C mutation/full UI — SPEC_AUTHORED / PENDING_REVIEW):** after DESIGN findings F1..F5 and concurrency feasibility F1 closed without waiver, canonical SPEC now defines R1-R29/AC-01..AC-35 over four gated checkpoints: assignment foundation → backend contract readiness → operator UI → supervisor closeout UI. It locks route scope, legacy recovery, CustomerRequest version, mutation preconditions, browser/PostgreSQL/provider evidence and claim exclusions. Next move is independent SPEC review; no WORK_ORDER/BUILD authority. **P2-R operational Report + freeze prerequisite remains FREEZE / CLOSED_BOUNDED:** C3 `18e24e58e2bda83e18be21d5d25ad50c4b0fa24e` changed exactly 59 authorized paths and is pushed after independent final `REVIEW_PASS`; final evidence focused 385, full 998/87 skipped, disposable PostgreSQL 77, retained provider receipt, doctor 24/1 and exact-parent rehearsal 788/77. Its claim remains only exact R33; no P5-A, managed PostgreSQL, P2-C/P2-D or Phase-2 completion.
