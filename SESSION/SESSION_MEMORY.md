...
_Last updated: 2026-07-31 (P2-C C3a1 exact Work Order approved; pre-BUILD sync next)_

## Where the project is
**2026-07-31 (P2-C mutation/full UI — C3a1 WORK_ORDER APPROVED):** `P2C-WO-FEAS-F1` closed by splitting C3a1 assignment persistence/staffing/bootstrap from C3a2 route enforcement. Exact C3a1 Work Order has 48 unique BUILD paths, zero wildcard/reserve/self-review path. `P2C-C3A1-WO-REV-F1..F2` closed without waiver and operator-delegated R2 approval is recorded. Next move after pushed authorization is a separate four-surface pre-BUILD sync; external worker receives prompt manually, no Claude CLI; no BUILD/provider call until clean-parent G6 passes. **P2-R remains FREEZE / CLOSED_BOUNDED:** C3 `18e24e58e2bda83e18be21d5d25ad50c4b0fa24e` changed 59 authorized paths and is pushed after independent final `REVIEW_PASS`; boundary remains exact R33 only, excluding P5-A, managed PostgreSQL, P2-C/P2-D and Phase 2.
