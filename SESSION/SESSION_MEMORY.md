...
**2026-08-03 (PROJECT-OPERATIONS-SKILL — AMENDMENT 1 REPAIR RESUMED):** authorization `64d5f7f` and required size-gate correction `27926c3` are pushed; original four-call bundle stays invalidated. Separate checkpoint transfers to REPAIR_WORKER. G6-R must pass before F1-F5 repair; exactly four replacement calls remain final-step-only, historical ceiling eight.
