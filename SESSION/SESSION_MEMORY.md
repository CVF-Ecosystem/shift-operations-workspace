...
_Last updated: 2026-07-30 (P2-R operational Report SPEC REVIEW_PASS; WORK_ORDER next; BUILD unauthorized)_

## Where the project is
**2026-07-30 (P2-R operational Report + freeze prerequisite — SPEC REVIEW_PASS):** canonical SPEC freezes R1-R33 and AC-01..AC-32 for fixed `END_SHIFT`, strict server snapshots/digests/limits, immutable current/history versions, R2 receipt approval, migration 007, backend/HTTP parity, retired override and atomic Report+Shift freeze. Authorization review caught and repaired `P2R-SPEC-REV-F1..F3` without waiver: stale snapshot can recover through a fresh successor, successor reason is optional except approved revocation, and even empty legacy override reason is refused. WORK_ORDER authoring is next; R2 human approval and pre-BUILD continuity are still required. P2-C/P2-D/P5-A remain unopened.
