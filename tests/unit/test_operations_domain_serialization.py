...
CVF-FILE-SPLIT-GUARD-HARDENING split the AC-09 OpenAPI-half and F14/F17
exact-contract tests into test_p2b_openapi_contract.py to keep this module
under the hard line limit; not a behavior change.
"""
...
# test_p2b_openapi_contract.py (CVF-FILE-SPLIT-GUARD-HARDENING). ---------
