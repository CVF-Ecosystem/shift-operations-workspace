...
def _seed_assignment(ledger, shift_id, user_id, role) -> None:
...
def _new_shift(ledger) -> Shift:
    ...
    _seed_assignment(ledger, shift.shift_id, "op1", "operator")
    _seed_assignment(ledger, shift.shift_id, "sup1", "shift_supervisor")
    return shift
