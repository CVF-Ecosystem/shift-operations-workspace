...
| Phase 4 AI and Channels | 🟡 `PARTIAL` (7/8 milestones closed) | P4-A/A1/A2/A3, P4-B, P4-C và P4-D `CLOSED_BOUNDED`; P4-E draft-r1 SPEC repaired | P4-E F1-F7 await independent rereview; Work Order and BUILD unauthorized |
...
## Phase 4 — AI and Channel Capabilities — 🟡 PARTIAL (7/8 milestones closed; P4-E SPEC repairs awaiting independent rereview)
...
- [~] **P4-E — `SPEC / REPAIRED_PENDING_INDEPENDENT_SPEC_REREVIEW` (updated 2026-09-09):** Human-confirmed internal-user mapping followed by deterministic non-truth workspace-triage/shift/incident placement. Generation 1 independent SPEC review returned seven findings; F1-F7 now have documentation/matrix repairs without waiver, including exact evidence commands, terminal refusal semantics, privacy/rotation separation, R-to-AC traceability, sole-store proof and closed scaffold boundaries. Findings remain open until independent rereview; no P4-E product source, provider call or BUILD authority exists.
...
**Next governed move (2026-09-09):** CVF inheritance recovery is closed bounded with public Core `483c5e33d` and required operator-local/private-provenance rule pack `bee38695e`. P4-E is now `SPEC / REPAIRED_PENDING_INDEPENDENT_SPEC_REREVIEW`; only independent rereview of F1-F7 may proceed. Work Order authoring/review follows only after PASS, and BUILD remains unauthorized. Phase 5 and external-repository absorption remain parked. Nguồn chuẩn: `next_allowed_move` trong `SESSION/ACTIVE_SESSION_STATE.json`.
